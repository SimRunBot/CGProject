...
CGProject-Linux-Debug:
	 $(PROJECTBUILD) CGProject Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGProject-Linux-DebugGame:
	 $(PROJECTBUILD) CGProject Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGProject-Linux-Shipping:
	 $(PROJECTBUILD) CGProject Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGProject-Linux-Test:
	 $(PROJECTBUILD) CGProject Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGProject:
	 $(PROJECTBUILD) CGProject Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGProjectEditor-Linux-Debug:
	 $(PROJECTBUILD) CGProjectEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGProjectEditor-Linux-DebugGame:
	 $(PROJECTBUILD) CGProjectEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGProjectEditor-Linux-Shipping:
	 $(PROJECTBUILD) CGProjectEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGProjectEditor-Linux-Test:
	 $(PROJECTBUILD) CGProjectEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

CGProjectEditor:
	 $(PROJECTBUILD) CGProjectEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
