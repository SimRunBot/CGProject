...
CGProjectRootPath=/home/leon/Dokumente/Unreal Projects/CGProject

gameProjectFile=/home/leon/Dokumente/Unreal Projects/CGProject/CGProject.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(CGProjectSource.pri)
include(CGProjectHeader.pri)
include(CGProjectConfig.pri)
include(CGProjectIncludes.pri)
include(CGProjectDefines.pri)
...
CGProject-Linux-Debug.commands = $$build CGProject Linux Debug  -project="\"$$gameProjectFile\"" $$args
CGProject-Linux-DebugGame.commands = $$build CGProject Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CGProject-Linux-Shipping.commands = $$build CGProject Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CGProject-Linux-Test.commands = $$build CGProject Linux Test  -project="\"$$gameProjectFile\"" $$args
CGProject.commands = $$build CGProject Linux Development  -project="\"$$gameProjectFile\"" $$args

CGProjectEditor-Linux-Debug.commands = $$build CGProjectEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
CGProjectEditor-Linux-DebugGame.commands = $$build CGProjectEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
CGProjectEditor-Linux-Shipping.commands = $$build CGProjectEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
CGProjectEditor-Linux-Test.commands = $$build CGProjectEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
CGProjectEditor.commands = $$build CGProjectEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	CGProject-Linux-Debug \
	CGProject-Linux-DebugGame \
	CGProject-Linux-Shipping \
	CGProject-Linux-Test \
	CGProject \
	CGProjectEditor-Linux-Debug \
	CGProjectEditor-Linux-DebugGame \
	CGProjectEditor-Linux-Shipping \
	CGProjectEditor-Linux-Test \
	CGProjectEditor \
